...
import com.dwilliam.ds.tuples.immutable.tuples.Pair;
import com.dwilliam.ds.tuples.serializable.immutable.intf.ISerializableImmutablePair;

import java.io.ObjectStreamException;
import java.io.Serializable;

public class SerializablePair<T1 extends Serializable, T2 extends Serializable> extends Pair<T1, T2> implements ISerializableImmutablePair<T1, T2> {
    ...
    @Override
    public SerializablePair<T1, T2> _1(T1 _1) {
        return new SerializablePair<>(_1, _2);
    }

    @Override
    public SerializablePair<T1, T2> first(T1 _1) {
        return new SerializablePair<>(_1, _2);
    }

    @Override
    public SerializablePair<T1, T2> _2(T2 _2) {
        return new SerializablePair<>(_1, _2);
    }

    @Override
    public SerializablePair<T1, T2> second(T2 _2) {
        return new SerializablePair<>(_1, _2);
    }

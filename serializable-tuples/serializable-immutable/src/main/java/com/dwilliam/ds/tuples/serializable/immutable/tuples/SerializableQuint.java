...
import com.dwilliam.ds.tuples.immutable.tuples.Quint;
import com.dwilliam.ds.tuples.serializable.immutable.intf.ISerializableImmutableQuint;
import com.dwilliam.ds.tuples.serializable.intf.tuples.*;

import java.io.ObjectStreamException;
import java.io.Serializable;

public class SerializableQuint<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable, T5 extends Serializable> extends Quint<T1, T2, T3, T4, T5> implements ISerializableImmutableQuint<T1, T2, T3, T4, T5> {
    ...
    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> _1(T1 _1) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> first(T1 _1) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> _2(T2 _2) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> second(T2 _2) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> _3(T3 _3) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> third(T3 _3) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> _4(T4 _4) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> fourth(T4 _4) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> _5(T5 _5) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

    @Override
    public SerializableQuint<T1, T2, T3, T4, T5> fifth(T5 _5) {
        return new SerializableQuint<>(_1, _2, _3, _4, _5);
    }

...
public interface ISerializableTriple<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable> extends ISerializableTuple, ITriple<T1, T2, T3>, Serializable {
    ...
    /**
     * Creates a serializable quad from the element of this triple and the specified single.
     *
     * @param single the single to append to this triple
    ...
    /**
     * Creates a serializable quint from the element of this triple and the specified pair.
     *
     * @param pair the pair to append to this triple
    ...
    /**
     * Creates a serializable sextuple from the element of this triple and the specified triple.
     *
     * @param triple the triple to append to this triple
    ...
    /**
     * Creates a serializable septuple from the element of this triple and the specified quad.
     *
     * @param quad the quad to append to this triple
    ...
    /**
     * Creates a serializable octa from the element of this triple and the specified quint.
     *
     * @param quint the quint to append to this triple
    ...
    /**
     * Creates a serializable nonuple from the element of this triple and the specified sextuple.
     *
     * @param sextuple the sextuple to append to this triple
    ...
    /**
     * Creates a serializable decuple from the element of this triple and the specified septuple.
     *
     * @param septuple the septuple to append to this triple

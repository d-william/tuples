...
import com.dwilliam.ds.tuples.mutable.tuples.Single;
import com.dwilliam.ds.tuples.serializable.mutable.intf.*;

import java.io.ObjectStreamException;
import java.io.Serializable;

public class SerializableSingle<T1 extends Serializable> extends Single<T1> implements ISerializableMutableSingle<T1> {

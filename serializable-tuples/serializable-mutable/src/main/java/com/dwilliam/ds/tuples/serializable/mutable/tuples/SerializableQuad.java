...
import com.dwilliam.ds.tuples.mutable.tuples.Quad;
import com.dwilliam.ds.tuples.serializable.mutable.intf.*;

import java.io.ObjectStreamException;
import java.io.Serializable;

public class SerializableQuad<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable> extends Quad<T1, T2, T3, T4> implements ISerializableMutableQuad<T1, T2, T3, T4> {

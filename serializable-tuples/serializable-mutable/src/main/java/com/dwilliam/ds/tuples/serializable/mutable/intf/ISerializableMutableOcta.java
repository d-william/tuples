...
/**
 * Marker interface for serializable mutable octas.
 *
 ...
 */
public interface ISerializableMutableOcta<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable, T5 extends Serializable, T6 extends Serializable, T7 extends Serializable, T8 extends Serializable> extends ISerializableOcta<T1, T2, T3, T4, T5, T6, T7, T8>, IMutableOcta<T1, T2, T3, T4, T5, T6, T7, T8> {

    @Override
    ISerializableMutableOcta<T1, T2, T3, T4, T5, T6, T7, T8> clone();

    @Override
    default <T9 extends Serializable> ISerializableMutableNonuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> appendSerializable(ISingle<T9> single) {
        return appendSerializable(single._1());
    }

    @Override
    default <T9 extends Serializable, T10 extends Serializable> ISerializableMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> appendSerializable(IPair<T9, T10> pair) {
        return appendSerializable(pair._1(),  pair._2());
    }

    @Override
    <T9 extends Serializable> ISerializableMutableNonuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> appendSerializable(T9 _9);

    @Override
    <T9 extends Serializable, T10 extends Serializable> ISerializableMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> appendSerializable(T9 _9, T10 _10);

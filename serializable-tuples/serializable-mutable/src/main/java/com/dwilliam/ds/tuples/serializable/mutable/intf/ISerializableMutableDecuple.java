...
/**
 * Marker interface for serializable mutable decuples.
 *
 ...
 */
public interface ISerializableMutableDecuple<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable, T5 extends Serializable, T6 extends Serializable, T7 extends Serializable, T8 extends Serializable, T9 extends Serializable, T10 extends Serializable> extends ISerializableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, IMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {

    @Override
    ISerializableMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> clone();

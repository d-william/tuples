...
/**
 * Marker interface for serializable mutable septuples.
 *
 ...
 */
public interface ISerializableMutableSeptuple<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable, T5 extends Serializable, T6 extends Serializable, T7 extends Serializable> extends ISerializableSeptuple<T1, T2, T3, T4, T5, T6, T7>, IMutableSeptuple<T1, T2, T3, T4, T5, T6, T7> {

    @Override
    ISerializableMutableSeptuple<T1, T2, T3, T4, T5, T6, T7> clone();

    @Override
    default <T8 extends Serializable> ISerializableMutableOcta<T1, T2, T3, T4, T5, T6, T7, T8> appendSerializable(ISingle<T8> single) {
        return appendSerializable(single._1());
    }

    @Override
    default <T8 extends Serializable, T9 extends Serializable> ISerializableMutableNonuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> appendSerializable(IPair<T8, T9> pair) {
        return appendSerializable(pair._1(),  pair._2());
    }

    @Override
    default <T8 extends Serializable, T9 extends Serializable, T10 extends Serializable> ISerializableMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> appendSerializable(ITriple<T8, T9, T10> triple) {
        return appendSerializable(triple._1(),  triple._2(), triple._3());
    }

    @Override
    <T8 extends Serializable> ISerializableMutableOcta<T1, T2, T3, T4, T5, T6, T7, T8> appendSerializable(T8 _8);

    @Override
    <T8 extends Serializable, T9 extends Serializable> ISerializableMutableNonuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> appendSerializable(T8 _8, T9 _9);

    @Override
    <T8 extends Serializable, T9 extends Serializable, T10 extends Serializable> ISerializableMutableDecuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> appendSerializable(T8 _8, T9 _9, T10 _10);

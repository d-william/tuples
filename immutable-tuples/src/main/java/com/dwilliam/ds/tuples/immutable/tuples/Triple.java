 ...
 */
public class Triple<T1, T2, T3> extends Tuple implements IImmutableTriple<T1, T2, T3> {
    ...
    @Override
    public Triple<T1, T2, T3> _1(T1 _1) {
        return new Triple<>(_1, _2, _3);
    }

    @Override
    public Triple<T1, T2, T3> first(T1 first) {
        return new Triple<>(first, _2, _3);
    }
    ...
    @Override
    public Triple<T1, T2, T3> _2(T2 _2) {
        return new Triple<>(_1, _2, _3);
    }

    @Override
    public Triple<T1, T2, T3> second(T2 second) {
        return new Triple<>(_1, second, _3);
    }
    ...
    @Override
    public Triple<T1, T2, T3> _3(T3 _3) {
        return new Triple<>(_1, _2, _3);
    }

    @Override
    public Triple<T1, T2, T3> third(T3 third) {
        return new Triple<>(_1, _2, third);
    }

 ...
 */
public class Quad<T1, T2, T3, T4> extends Tuple implements IImmutableQuad<T1, T2, T3, T4> {
    ...
    @Override
    public Quad<T1, T2, T3, T4> _1(T1 _1) {
        return new Quad<>(_1, _2, _3, _4);
    }

    @Override
    public Quad<T1, T2, T3, T4> first(T1 first) {
        return new Quad<>(first, _2, _3, _4);
    }
    ...
    @Override
    public Quad<T1, T2, T3, T4> _2(T2 _2) {
        return new Quad<>(_1, _2, _3, _4);
    }

    @Override
    public Quad<T1, T2, T3, T4> second(T2 second) {
        return new Quad<>(_1, second, _3, _4);
    }
    ...
    @Override
    public Quad<T1, T2, T3, T4> _3(T3 _3) {
        return new Quad<>(_1, _2, _3, _4);
    }

    @Override
    public Quad<T1, T2, T3, T4> third(T3 third) {
        return new Quad<>(_1, _2, third, _4);
    }
    ...
    @Override
    public Quad<T1, T2, T3, T4> _4(T4 _4) {
        return new Quad<>(_1, _2, _3, _4);
    }

    @Override
    public Quad<T1, T2, T3, T4> fourth(T4 fourth) {
        return new Quad<>(_1, _2, _3, fourth);
    }

...
/**
 * A immutable 2-tuple (Ordered pair).
 *
 * @param <T1> the type of the first element of the pair
 * @param <T2> the type of the second element of the pair
 */
public class Pair<T1, T2> extends Tuple implements IImmutablePair<T1, T2> {
    ...
    @Override
    public Pair<T1, T2> _1(T1 _1) {
        return new Pair<>(_1, _2);
    }

    @Override
    public Pair<T1, T2> first(T1 first) {
        return new Pair<>(first, _2);
    }
    ...
    @Override
    public Pair<T1, T2> _2(T2 _2) {
        return new Pair<>(_1, _2);
    }

    @Override
    public Pair<T1, T2> second(T2 second) {
        return new Pair<>(_1, second);
    }
